...
from clavi_agent.tools.skill_loader import SkillLoader
from clavi_agent.tools.skill_tool import GetSkillTool, create_skill_tools
...
async def test_get_skill_tool(skill_loader):
    ...
    assert "Skill root:" in result.content
    assert "Use this directory as the base path" in result.content
