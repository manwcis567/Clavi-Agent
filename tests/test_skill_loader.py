...
from clavi_agent.tools.skill_loader import Skill, SkillLoader, build_skills_description_prompt
...
def test_build_skills_description_prompt():
    """Persisted skill metadata should become a compact prompt section."""
    prompt = build_skills_description_prompt(
        [
    ...
    assert "Frontend workflow" in prompt
    assert "`openai-docs`" in prompt
