...
from clavi_agent.llm import LLMClient
from clavi_agent.schema import LLMProvider, Message
...
async def test_wrapper_anthropic_provider():
    ...
    messages = [
        ...
        Message(role="user", content="Say 'Hello, Clavi Agent!' and nothing else."),
    ]
